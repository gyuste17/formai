...
```mermaid
flowchart TD
    A[Necesidad de Transformación Digital en la Empresa] --> B[Diseño de Temario Práctico Aplicado al Puesto]
    B --> C[Comunicación Previa en Aplicativo FUNDAE >= 2 días]
    C --> D[Impartición en Aula Virtual con Formador en Directo]
    D --> E[Acreditación de Asistencia >= 75% y Encuestas]
    E --> F[Bonificación 100% en Seguros Sociales RLC a 13€/h/alumno]
```
