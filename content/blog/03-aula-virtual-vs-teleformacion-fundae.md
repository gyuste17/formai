...
```mermaid
flowchart TD
    subgraph Síncrona ["Aula Virtual (Asimilada a Presencial)"]
        A1[Formador y alumnos conectados a la vez en directo]
        A2[Interacción bidireccional por voz, vídeo o chat]
        A3[Módulo Superior: Hasta 13,00 € / hora / alumno]
    end
    subgraph Asíncrona ["Teleformación (Online LMS)"]
        B1[Contenidos grabados / plataforma 24/7]
        B2[Tutorías periódicas no obligatorias en directo]
        B3[Módulo Superior: Hasta 7,50 € / hora / alumno]
    end
```
...
```mermaid
timeline
    title Checklist de Cumplimiento Técnico FUNDAE para Aula Virtual
    1. Plataforma Interactiva : Conexión simultánea bidireccional de audio, vídeo y pantalla compartida
    2. Logs de Conexión : Reporte automático del software con nombre, email, IP, hora entrada y salida
    3. Acceso para Seguimiento : Enlace directo facilitado en el aplicativo para inspectores del SEPE
    4. Control del 75% : Comprobación de que cada alumno supera el 75% del tiempo total programado
```
